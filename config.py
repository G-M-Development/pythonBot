...
translations = {
    'en': {
        ...
        'phone_error' : "Please enter number in format +1(123)456-78-90 or 1-123-456-78-90 or 1.123.456.78.90",
    ...
    'ua': {
        ...
        'phone_error' : "Будь ласка введіть номер в форматі +1(123)456-78-90 або 1-123-456-78-90 або 1.123.456.78.90",
    ...
    'ru': {
        ...
        'phone_error' : "Пожалуйста введите номер в формате +1(123)456-78-90 или 1-123-456-78-90 или 1.123.456.78.90",
